...
namespace Player
{
	public class PlayerLocomotionManager : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if (player.IsOwner)
			{
				player.playerNetworkManager.verticalMovement.Value = verticalMovement;
				player.playerNetworkManager.horizontalMovement.Value = horizontalMovement;
			}
			else
			{
				horizontalMovement = player.playerNetworkManager.horizontalMovement.Value;
				verticalMovement = player.playerNetworkManager.verticalMovement.Value;
